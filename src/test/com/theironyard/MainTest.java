...
public class MainTest {
    ...
    public void testSelectEvents() throws SQLException {
        ...
        User user = Main.selectUser(conn, "Alice");
        LocalDate date = LocalDate.now();
        Main.insertEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "dooplepary"), user);
        Main.insertEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "dooplepaty"), user);
        Main.insertEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "doopleprty"), user);
        Main.insertEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "dooplearty"), user);
    ...
    public void testSelectMyEvents() throws SQLException {
        ...
        User user = Main.selectUser(conn, "Alice");
        LocalDate date = LocalDate.now();
        Main.insertMyEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "dooplepary"), user);
        Main.insertMyEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "dooplepaty"), user);
        Main.insertMyEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "doopleprty"), user);
        Main.insertMyEvent(conn, new Event(1, user.userName, "doople", date, "dooplia", "dooplearty"), user);
